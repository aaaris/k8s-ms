...
public class PodServiceImpl implements PodService {
    ...
    @Override
    public List<V1Pod> list() throws ApiException, IOException {
        ApiClient apiClient = kubeConfig.getApiClient();
    ...
    @Override
    public List<V1Pod> listByNamespace(String namespace) throws ApiException, IOException {
        ApiClient apiClient = kubeConfig.getApiClient();
        CoreV1Api api = new CoreV1Api(apiClient);
    ...
    @Override
    public V1Pod getByName(String name, String namespace) throws ApiException, IOException {
        ApiClient apiClient = kubeConfig.getApiClient();
        CoreV1Api api = new CoreV1Api(apiClient);
    ...
    @Override
    public V1Pod create(V1PodDto v1PodDto, String namespace) throws IOException, ApiException {
        ApiClient apiClient = kubeConfig.getApiClient();
        CoreV1Api api = new CoreV1Api(apiClient);
